...
* Usage: (lxs)
1. $ gcc -shared -o /opt/sublime_text/libsublime-imfix.so sublime-imfix.c  `pkg-config --libs --cflags gtk+-2.0` -fPIC
2. $ LD_PRELOAD=./libsublime-imfix.so subl
3. edit file `/usr/share/applications/sublime_text.desktop` as below:
```
	[Desktop Entry]
	[...]
