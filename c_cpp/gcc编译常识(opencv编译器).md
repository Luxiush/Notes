...
if exist %name%.cpp (
	g++ %name%.cpp -I"D:opencv_neccessary\\include" -O2 -g3 -Wall -c -fmessage-length=0 -o %name%.o 
)else echo there is no such file %name%.cpp.

if exist %name%.o   g++ %name%.o -L"D:opencv_neccessary\\lib" -llibopencv_core249 -llibopencv_highgui249 -llibopencv_imgproc249 -o %name%.exe
